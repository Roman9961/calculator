 ...
 */
final class Version20190304143118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_print (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_post_print DROP FOREIGN KEY FK_11AAAFA279CCBA0D');
        $this->addSql('DROP TABLE product_post_print');
        $this->addSql('DROP TABLE post_print');
    }
}
